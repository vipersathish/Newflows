...
public class RescheduleFlowForIAAS extends Initializer {
	...
	@Parameters({ "screenshotName_4", "screenshotName_5", "screenshotName_6", "screenshotName_7", "screenshotName_8",
			"Reason", "comment", "date_1", "time_1", "sec_1", "preorsuf_1" })
	@Test(priority = 6)

	public void ScheduleWithRescheduleButtonFlow(String screenshotName_4, String screenshotName_5,
			String screenshotName_6, String screenshotName_7, String screenshotName_8, String Reason, String comment,
			String date_1, String time_1, String sec_1, String preorsuf_1) throws InterruptedException {
		...
		CandidateProfilePage.clickScheduleWithRescheduleButton();
		...
		CandidateProfilePage.clickPopupRescheduleSubmitButton();
	...
	@Parameters({"screenshotName_9","screenshotName_10","screenshotName_11","screenshotName_12","screenshotName_13","screenshotName_14","screenshotName_15"})
	@Test(priority = 7)

	public void CheckRescheduleWithManualScheduleStatus(String screenshotName_9,String screenshotName_10,String screenshotName_11,String screenshotName_12,String screenshotName_13,String screenshotName_14,String screenshotName_15) throws InterruptedException {
